...
;; TESTNET: 'ST1XQXW9JNQ1W4A7PYTN3HCHPEY7SHM6KPA085ES6.citycoin-token-v2-trait.citycoin-token-v2
...
(define-public (create-job-mia (name (string-ascii 255)) (target principal))
  (begin
    ...
    (as-contract (contract-call? .miamicoin-auth-v2 create-job name target))
  )
)
(define-public (create-job-nyc (name (string-ascii 255)) (target principal))
  (begin
    ...
    (as-contract (contract-call? .newyorkcitycoin-auth-v2 create-job name target))
  )
)
...
(define-public (activate-job-mia (jobId uint))
  (begin
    ...
    ;; MAINNET: 'SP1H1733V5MZ3SZ9XRW9FKYGEZT0JDGEB8Y634C7R.miamicoin-auth-v2
    ;; TESTNET: 'ST1H1733V5MZ3SZ9XRW9FKYGEZT0JDGEB8WRH7C6H.miamicoin-auth-v2
    (as-contract (contract-call? .miamicoin-auth-v2 activate-job jobId))
  )
)
(define-public (activate-job-nyc (jobId uint))
  (begin
    ...
    ;; MAINNET: 'SPSCWDV3RKV5ZRN1FQD84YE1NQFEDJ9R1F4DYQ11.newyorkcitycoin-auth-v2
    ;; TESTNET: 'STSCWDV3RKV5ZRN1FQD84YE1NQFEDJ9R1D64KKHQ.newyorkcitycoin-auth-v2
    (as-contract (contract-call? .newyorkcitycoin-auth-v2 activate-job jobId))
  )
)
...
(define-public (approve-job-mia (jobId uint))
  (begin
    ...
    ;; MAINNET: 'SP1H1733V5MZ3SZ9XRW9FKYGEZT0JDGEB8Y634C7R.miamicoin-auth-v2
    ;; TESTNET: 'ST1H1733V5MZ3SZ9XRW9FKYGEZT0JDGEB8WRH7C6H.miamicoin-auth-v2
    (as-contract (contract-call? .miamicoin-auth-v2 approve-job jobId))
  )
)
(define-public (approve-job-nyc (jobId uint))
  (begin
    ...
    ;; MAINNET: 'SPSCWDV3RKV5ZRN1FQD84YE1NQFEDJ9R1F4DYQ11.newyorkcitycoin-auth-v2
    ;; TESTNET: 'STSCWDV3RKV5ZRN1FQD84YE1NQFEDJ9R1D64KKHQ.newyorkcitycoin-auth-v2
    (as-contract (contract-call? .newyorkcitycoin-auth-v2 approve-job jobId))
  )
)
...
(define-public (disapprove-job-mia (jobId uint))
  (begin
    ...
    ;; MAINNET: 'SP1H1733V5MZ3SZ9XRW9FKYGEZT0JDGEB8Y634C7R.miamicoin-auth-v2
    ;; TESTNET: 'ST1H1733V5MZ3SZ9XRW9FKYGEZT0JDGEB8WRH7C6H.miamicoin-auth-v2
    (as-contract (contract-call? .miamicoin-auth-v2 disapprove-job jobId))
  )
)
(define-public (disapprove-job-nyc (jobId uint))
  (begin
    ...
    ;; MAINNET: 'SPSCWDV3RKV5ZRN1FQD84YE1NQFEDJ9R1F4DYQ11.newyorkcitycoin-auth-v2
    ;; TESTNET: 'STSCWDV3RKV5ZRN1FQD84YE1NQFEDJ9R1D64KKHQ.newyorkcitycoin-auth-v2
    (as-contract (contract-call? .newyorkcitycoin-auth-v2 disapprove-job jobId))
  )
)
...
(define-public (add-uint-argument-mia (jobId uint) (name (string-ascii 255)) (value uint))
  (begin
    ...
    ;; MAINNET: 'SP1H1733V5MZ3SZ9XRW9FKYGEZT0JDGEB8Y634C7R.miamicoin-auth-v2
    ;; TESTNET: 'ST1H1733V5MZ3SZ9XRW9FKYGEZT0JDGEB8WRH7C6H.miamicoin-auth-v2
    (as-contract (contract-call? .miamicoin-auth-v2 add-uint-argument jobId name value))
  )
)
(define-public (add-uint-argument-nyc (jobId uint) (name (string-ascii 255)) (value uint))
  (begin
    ...
    ;; MAINNET: 'SPSCWDV3RKV5ZRN1FQD84YE1NQFEDJ9R1F4DYQ11.newyorkcitycoin-auth-v2
    ;; TESTNET: 'STSCWDV3RKV5ZRN1FQD84YE1NQFEDJ9R1D64KKHQ.newyorkcitycoin-auth-v2
    (as-contract (contract-call? .newyorkcitycoin-auth-v2 add-uint-argument jobId name value))
  )
)
...
(define-public (add-principal-argument-mia (jobId uint) (name (string-ascii 255)) (value principal))
  (begin
    ...
    ;; MAINNET: 'SP1H1733V5MZ3SZ9XRW9FKYGEZT0JDGEB8Y634C7R.miamicoin-auth-v2
    ;; TESTNET: 'ST1H1733V5MZ3SZ9XRW9FKYGEZT0JDGEB8WRH7C6H.miamicoin-auth-v2
    (as-contract (contract-call? .miamicoin-auth-v2 add-principal-argument jobId name value))
  )
)
(define-public (add-principal-argument-nyc (jobId uint) (name (string-ascii 255)) (value principal))
  (begin
    ...
    ;; MAINNET: 'SPSCWDV3RKV5ZRN1FQD84YE1NQFEDJ9R1F4DYQ11.newyorkcitycoin-auth-v2
    ;; TESTNET: 'STSCWDV3RKV5ZRN1FQD84YE1NQFEDJ9R1D64KKHQ.newyorkcitycoin-auth-v2
    (as-contract (contract-call? .newyorkcitycoin-auth-v2 add-principal-argument jobId name value))
  )
)
...
(define-public (execute-upgrade-core-contract-job-mia (jobId uint) (oldContract <coreTraitV2>) (newContract <coreTraitV2>))
  (begin
    ...
    ;; MAINNET: 'SP1H1733V5MZ3SZ9XRW9FKYGEZT0JDGEB8Y634C7R.miamicoin-auth-v2
    ;; TESTNET: 'ST1H1733V5MZ3SZ9XRW9FKYGEZT0JDGEB8WRH7C6H.miamicoin-auth-v2
    (as-contract (contract-call? .miamicoin-auth-v2 execute-upgrade-core-contract-job jobId oldContract newContract))
  )
)
(define-public (execute-upgrade-core-contract-job-nyc (jobId uint) (oldContract <coreTraitV2>) (newContract <coreTraitV2>))
  (begin
    ...
    ;; MAINNET: 'SPSCWDV3RKV5ZRN1FQD84YE1NQFEDJ9R1F4DYQ11.newyorkcitycoin-auth-v2
    ;; TESTNET: 'STSCWDV3RKV5ZRN1FQD84YE1NQFEDJ9R1D64KKHQ.newyorkcitycoin-auth-v2
    (as-contract (contract-call? .newyorkcitycoin-auth-v2 execute-upgrade-core-contract-job jobId oldContract newContract))
  )
)
...
(define-public (execute-update-coinbase-thresholds-job-mia (jobId uint) (targetCore <coreTraitV2>) (targetToken <tokenTraitV2>))
  (begin
    ...
    ;; MAINNET: 'SP1H1733V5MZ3SZ9XRW9FKYGEZT0JDGEB8Y634C7R.miamicoin-auth-v2
    ;; TESTNET: 'ST1H1733V5MZ3SZ9XRW9FKYGEZT0JDGEB8WRH7C6H.miamicoin-auth-v2
    (as-contract (contract-call? .miamicoin-auth-v2 execute-update-coinbase-thresholds-job jobId targetCore targetToken))
  )
)
(define-public (execute-update-coinbase-thresholds-job-nyc (jobId uint) (targetCore <coreTraitV2>) (targetToken <tokenTraitV2>))
  (begin
    ...
    ;; MAINNET: 'SPSCWDV3RKV5ZRN1FQD84YE1NQFEDJ9R1F4DYQ11.newyorkcitycoin-auth-v2
    ;; TESTNET: 'STSCWDV3RKV5ZRN1FQD84YE1NQFEDJ9R1D64KKHQ.newyorkcitycoin-auth-v2
    (as-contract (contract-call? .newyorkcitycoin-auth-v2 execute-update-coinbase-thresholds-job jobId targetCore targetToken))
  )
)
...
(define-public (execute-update-coinbase-amounts-job-mia (jobId uint) (targetCore <coreTraitV2>) (targetToken <tokenTraitV2>))
  (begin
    ...
    ;; MAINNET: 'SP1H1733V5MZ3SZ9XRW9FKYGEZT0JDGEB8Y634C7R.miamicoin-auth-v2
    ;; TESTNET: 'ST1H1733V5MZ3SZ9XRW9FKYGEZT0JDGEB8WRH7C6H.miamicoin-auth-v2
    (as-contract (contract-call? .miamicoin-auth-v2 execute-update-coinbase-amounts-job jobId targetCore targetToken))
  )
)
(define-public (execute-update-coinbase-amounts-job-nyc (jobId uint) (targetCore <coreTraitV2>) (targetToken <tokenTraitV2>))
  (begin
    ...
    ;; MAINNET: 'SPSCWDV3RKV5ZRN1FQD84YE1NQFEDJ9R1F4DYQ11.newyorkcitycoin-auth-v2
    ;; TESTNET: 'STSCWDV3RKV5ZRN1FQD84YE1NQFEDJ9R1D64KKHQ.newyorkcitycoin-auth-v2
    (as-contract (contract-call? .newyorkcitycoin-auth-v2 execute-update-coinbase-amounts-job jobId targetCore targetToken))
  )
)
...
(define-public (execute-replace-approver-job-mia (jobId uint))
  (begin
    ...
    ;; MAINNET: 'SP1H1733V5MZ3SZ9XRW9FKYGEZT0JDGEB8Y634C7R.miamicoin-auth-v2
    ;; TESTNET: 'ST1H1733V5MZ3SZ9XRW9FKYGEZT0JDGEB8WRH7C6H.miamicoin-auth-v2
    (as-contract (contract-call? .miamicoin-auth-v2 execute-replace-approver-job jobId))
  )
)
(define-public (execute-replace-approver-job-nyc (jobId uint))
  (begin
    ...
    ;; MAINNET: 'SPSCWDV3RKV5ZRN1FQD84YE1NQFEDJ9R1F4DYQ11.newyorkcitycoin-auth-v2
    ;; TESTNET: 'STSCWDV3RKV5ZRN1FQD84YE1NQFEDJ9R1D64KKHQ.newyorkcitycoin-auth-v2
    (as-contract (contract-call? .newyorkcitycoin-auth-v2 execute-replace-approver-job jobId))
  )
)
